<?php
/**
 * Runner de migraciones — RestaurantOS
 *
 *   USO (CLI):  php migrations/migrate.php
 *   USO (web):  http://localhost/restaurant/migrations/migrate.php?token=...
 *
...
if (!$esCli && !$esLoc) {
    $token    = $_GET['token'] ?? '';
    $esperado = defined('MIGRATIONS_TOKEN') ? MIGRATIONS_TOKEN : 'restaurant_2026_migrations';
