<?php
/**
 * RestaurantOS — Configuración SUNAT
 * ──────────────────────────────────
 * Auto-detecta entorno (LOCAL vs PRODUCCIÓN) por SO/hostname.
 */
...
define('SUNAT_NOMBRE_COMERCIAL', defined('RESTAURANT_NAME') ? RESTAURANT_NAME : 'RestaurantOS');
